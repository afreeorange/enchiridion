...
% Different size
% Page numbering from first page of text
...
\fancyhead{}
\fancyfoot{}
\fancyhead[RE]{\color{Gray}\small{\uppercase{Enchiridion}}}
\fancyhead[LO]{\color{Gray}\small{\uppercase{Epictetus}}}
\fancyfoot[CE]{\color{Gray}\thepage}
\fancyfoot[CO]{\color{Gray}\thepage}
